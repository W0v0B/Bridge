...
import { runHdcShellCommand } from "../../utils/hdc";

interface HdcCatModalProps {
  open: boolean;
  onClose: () => void;
  connectKey: string;
  path: string;
...
export function HdcCatModal({ open, onClose, connectKey, path }: HdcCatModalProps) {
  ...
  const fetchContent = useCallback(async () => {
    ...
    try {
      const result = await runHdcShellCommand(connectKey, cmd);
      setOutput(result);
